...
def run_misclassify_upweight(val_data, test_data, c, lam, epochs_sel, lr_sel, w_decay_sel, c_sel):
    ...
    data_ds = detector.run_detection_model(epochs=epochs_sel, lr=lr_sel, weight_decay=w_decay_sel, c_sel=c_sel, opt='AdamW', lr_scheduler = 'none')
...
LR_VALUES = [1e-5]
LAMBDA_VALUES= np.linspace(5, 20, 5)
ITER_VALUES = [60]
...
final_results.to_csv('results/hparams_RAD_l1_wb.csv', mode='a', header=True)