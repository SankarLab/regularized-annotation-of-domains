...
def run_misclassify_upweight(val_data, test_data, c, lam, epochs_sel, lr_sel, w_decay_sel):
    ...
    data_ds = detector.run_detection_model(epochs=epochs_sel, lr=lr_sel, weight_decay=w_decay_sel, opt='AdamW', lr_scheduler = 'none')
...
final_results.to_csv('results/hparams_RAD_l2_l1_wb.csv', mode='a', header=True)